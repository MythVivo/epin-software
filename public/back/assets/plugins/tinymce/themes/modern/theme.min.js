!function () {
    ...
    var e, t, n, i, r, o = tinymce.util.Tools.resolve("tinymce.ThemeManager"),
        h = tinymce.util.Tools.resolve("tinymce.EditorManager"), w = tinymce.util.Tools.resolve("tinymce.util.Tools"),
        d = function (e) {
            return !1 !== c(e)
        }, c = function (e) {
        ...
        }, v = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), b = tinymce.util.Tools.resolve("tinymce.ui.Factory"),
        y = tinymce.util.Tools.resolve("tinymce.util.I18n"), s = function (e) {
        ...
        E = function () {
        ...
        }, l = k(!1), T = k(!0), H = l, S = T, M = function () {
            return N
        }, N = (i = {
            fold: function (e, t) {
                return e()
            }, is: H, isSome: H, isNone: S, getOr: n = function (e) {
                return e
                ...
                return undefined
            }, or: n, orThunk: t, map: M, ap: M, each: function () {
            }, bind: M, flatten: M, exists: H, forall: S, filter: M, equals: e = function (e) {
                return e.isNone()
            }, equals_: e, toArray: function () {
                return []
            }, toString: k("none()")
        }, Object.freeze && Object.freeze(i), i), P = function (n) {
            var e = function () {
                return n
            }, t = function () {
                return r
            ...
            getUiContainerDelta: function (e) {
                ...
                if (t && "static" !== v.DOM.getStyle(t, "position", !0)) {
                    var n = v.DOM.getPos(t), i = t.scrollLeft - n.x, r = t.scrollTop - n.y;
            ...
            }, getUiContainer: W, inheritUiContainer: function (e, t) {
            ...
            var i, o = function () {
                ...
                if (!x.removed) {
                    ...
                    var g, p, v, b = O.getUiContainerDelta(s).getOr({x: 0, y: 0});
                ...
                t = b.create({
                    ...
                    if (!i) {
                        var t = r(!0), n = O.getUiContainer(e);
        ...
        }, $ = Y("function"), X = Y("number"), q = (r = Array.prototype.indexOf) === undefined ? function (e, t) {
            return ee(e, t)
        } : function (e, t) {
            return r.call(e, t)
        }, j = function (e, t) {
            ...
            var r, o, s, a, l, u, c;
            return e ? (o = e[i], a = !0) : o = ne[i], o && (r = {text: o.title}, s = [], w.each((o.items || "").split(/[ ,]/), function (e) {
                var t = ie(e, n[e]);
                t && s.push(t)
            ...
            if (!1 === g(t) && n.skinUiCss ? be.styleSheetLoader.load(n.skinUiCss, ve(t)) : ve(t)(), i = e.panel = b.create({
                ...
                items: [{
                    type: "container",
                    classes: "top-part",
                    items: [!1 === d(t) ? null : {type: "menubar", border: "0 0 1 0", items: se(t)}, L(t, f(t))]
                }, ge(t) ? (s = t, {
                    type: "panel",
                    layout: "stack",
                ...
                var l = y.translate(["", '<a href="https://www.tinymce.com/?utm_campaign=editor_referral&amp;utm_medium=poweredby&amp;utm_source=tinymce" rel="noopener" target="_blank" role="presentation" tabindex="-1">tinymce</a>']),
            ...
            return _(t), t.on("SwitchMode", (a = i, function (e) {
                ...
                i.remove(), i = null
            }), C(t, i), V(t), {iframeContainer: i.find("#iframe")[0].getEl(), editorContainer: i.getEl()}
    ...
    var Te = function () {
            ...
            return n && !Ee(e) ? {x: 0, y: 0, w: (t = n).scrollWidth - 1, h: t.scrollHeight - 1} : Te()
        }, Se = {
        ...
        Ne = tinymce.util.Tools.resolve("tinymce.util.EventDispatcher"), Pe = function (e) {
            var t;
    ...
    var Ae, Be, Le,
        ...
        }), Ve = Array.prototype.push, Ye = Array.prototype.slice;
    Le = {
    ...
    var $e = Ue.Collection = Be, Xe = function (e) {
    ...
    var Je, Ge, Ke = Me.extend({
    ...
    }, et = "onmousewheel" in document, tt = !1, nt = 0, it = {
        Statics: {classPrefix: "mce-"}, isRtl: function () {
            ...
            i.settings = t = w.extend({}, i.Defaults, t), i._id = t.id || "mceu_" + nt++, i._aria = {role: t.role}, i._elmCache = {}, i.$ = we, i.state = new Ke({
                visible: !0,
                active: !1,
                disabled: !1,
                value: ""
    ...
    var st = Ge = Me.extend(it), at = function (e) {
    ...
    var ut = {}, ct = st.extend({
        init: function (e) {
            ...
            return w.isArray(e) || (e = [e]), w.each(e, function (e) {
                e && (e instanceof st || ("string" == typeof e && (e = {type: e}), t = w.extend({}, n.settings.defaults, e), e.type = t.type = t.type || e.type || n.settings.defaultType || (t.defaults ? t.defaults.type : null), e = b.create(t)), i.push(e))
            }), i
        }, renderNew: function () {
            var i = this;
            ...
            })), t.parent() || (t.keyboardNav = lt({root: t})), t
        }, initLayoutRect: function () {
            var e = this._super();
    ...
    var ht, mt, gt, pt, vt = {
        ...
        Defaults: {layout: "fit", containerCls: "panel"}, Mixins: [vt], renderHtml: function () {
        ...
        ht || (ht = function (e) {
            2 !== e.button && function (e) {
                for (var t = xt.length; t--;) {
                    var n = xt[t], i = n.getParentCtrl(e.target);
    ...
    function Et(e, t) {
        ...
        if (e) wt.push(t); else for (n = wt.length; n--;) wt[n] === t && wt.splice(n, 1);
    ...
    var Ht = function (e, t) {
        ...
        var a, n, l = v.DOM, i = s.getParam("fixed_toolbar_container");
        i && (n = l.select(i)[0]);
        var r = function () {
            ...
            a ? a.visible() || o() : (a = e.panel = b.create({
                ...
                fixed: Ht(n, s),
                border: 1,
                items: [!1 === d(s) ? null : {type: "menubar", border: "0 0 1 0", items: se(s)}, L(s, f(s))]
    ...
    function Mt(i, r) {
        var o, s, a = this, l = st.classPrefix;
        a.show = function (e, t) {
            function n() {
    ...
    var Nt = function (e, t) {
        ...
        Mixins: [Se], Defaults: {classes: "widget tooltip tooltip-n"}, renderHtml: function () {
        ...
        init: function (i) {
            ...
            return this._tooltip || (this._tooltip = new Dt({type: "tooltip"}), O.inheritUiContainer(this, this._tooltip), this._tooltip.renderTo()), this._tooltip
        }, postRender: function () {
        ...
        Mixins: [Se], Defaults: {classes: "widget notification"}, init: function (e) {
            var t = this;
    ...
    function Lt(o) {
        ...
        return {
            open: function (e, t) {
                var n, i = w.extend(e, {maxWidth: (n = s(o), Ce.getSize(n).width)}), r = new Bt(i);
    ...
    var Vt = kt.extend({
        ...
        fullscreen: function (e) {
            ...
            if (e !== i._fullscreen) if (we(window).on("resize", function () {
                var e;
    ...
    !function () {
        if (!fe.desktop) {
            ...
            u.setInterval(function () {
                ...
                n.w === e && n.h === t || (n = {w: e, h: t}, we(window).trigger("resize"))
            }, 100)
        }
    ...
    var Yt = Vt.extend({
            ...
            init: function (e) {
                ...
                var n = this, t = Ce.create("input", {type: "file", id: n._id + "-browse", accept: n.settings.accept});
        ...
        }), Zt = tinymce.util.Tools.resolve("tinymce.util.VK"), Qt = Wt.extend({
            init: function (i) {
                var r = this;
        ...
        }), on = tinymce.util.Tools.resolve("tinymce.util.Color"), sn = Wt.extend({
            Defaults: {classes: "widget colorpicker"}, init: function (e) {
                ...
                function c(e, t) {
                    var n = (360 - e.h) / 360;
                    Ce.css(r, {top: 100 * n + "%"}), t || Ce.css(s, {
                        left: e.s + "%",
                        top: 100 - e.v + "%"
                    }), o.style.background = on({s: 100, v: 100, h: e.h}).toHex(), a.color().parse({s: e.s, v: e.v, h: e.h})
                }
                ...
                i = a.getEl("h"), r = a.getEl("hp"), o = a.getEl("sv"), s = a.getEl("svp"), a._repaint = function () {
                    ...
                    start: e,
                    drag: e
                }), a._hdraghelper = new ft(a._id + "-h", {start: t, drag: t}), a._repaint()
            }, rgb: function () {
            ...
            fromHtml: function (e, t) {
                ...
                return mn(n)
            }, fromDom: mn, fromPoint: function (e, t, n) {
                var i = e.dom();
            ...
            nu: Cn, detect: function (e, t) {
                var n = String(t).toLowerCase();
                return 0 === e.length ? _n() : wn(e, n)
            }, unknown: _n
        }, En = "Firefox", kn = function (e, t) {
            return function () {
                return t === e
            }
        }, Tn = function (e) {
            ...
            firefox: k(En),
            safari: k("Safari")
        }, Sn = "Windows", Mn = "Android", Nn = "Solaris", Pn = "FreeBSD", Dn = function (e, t) {
            return function () {
                return t === e
            }
        }, Wn = function (e) {
        ...
        }, zn = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, Fn = function (t) {
            return function (e) {
                return In(e, t)
            }
        }, Un = [{
            ...
            name: "Chrome", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, zn], search: function (e) {
        ...
        }, {name: "Opera", versionRegexes: [zn, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: Fn("opera")}, {
            name: "Firefox",
            versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/],
            search: Fn("firefox")
        }, {
            name: "Safari", versionRegexes: [zn, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
        ...
        }, {name: "Android", search: Fn("android"), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/]}, {
            name: "OSX",
            search: Fn("os x"),
            ...
            search: Fn("sunos"),
            versionRegexes: []
        }, {name: "FreeBSD", search: Fn("freebsd"), versionRegexes: []}], Yn = {browsers: k(Un), oses: k(Vn)},
        $n = function (e) {
            var t, n, i, r, o, s, a, l, u, c, d, f = Yn.browsers(), h = Yn.oses(), m = Bn(f, e).fold(Hn.unknown, Hn.nu),
            ...
            return $n(e)
        }), qn = vn.ELEMENT, jn = vn.DOCUMENT, Jn = function (e) {
        ...
        }, ei = Qn("true"), ti = Qn("false"), ni = function (e, t, n, i, r) {
            ...
            var n, o, s, a, l, u, c = {title: "-"}, d = function (e) {
                var t = e.hasOwnProperty(r) ? e[r] : [], n = K(t, function (e) {
            ...
            Statics: {
                ...
                var t, n, i, r, o, s, a, l, u = this, c = window.tinymce ? window.tinymce.activeEditor : h.activeEditor,
                    d = c.settings, f = e.filetype;
                e.spellcheck = !1, (i = d.file_picker_types || d.file_browser_callback_types) && (i = w.makeMap(i, /[, ]/)), i && !i[f] || (!(n = d.file_picker_callback) || i && !i[f] ? !(n = d.file_browser_callback) || i && !i[f] || (t = function () {
                    ...
                    e = w.extend({filetype: f}, e), n.call(c, function (e, t) {
                    ...
                    "image" === a ? r.fire("change", {meta: {alt: i, attach: t.attach}}) : r.fire("change", {
                        meta: {
                            text: i,
                            attach: t.attach
                        }
            ...
            recalc: function (e) {
                var t, n, i, r, o, s, a, l, u, c, d, f, h, m, g, p, v, b, y, x, w, _, C, R, E, k, T, H, S, M, N, P, D, W, O,
            ...
            var t = ["alignleft", "aligncenter", "alignright", "alignjustify"], r = "alignleft",
                e = [{text: "Left", icon: "alignleft", onclick: Ti(i, "alignleft")}, {
                    text: "Center",
                    icon: "aligncenter",
                    onclick: Ti(i, "aligncenter")
                }, {text: "Right", icon: "alignright", onclick: Ti(i, "alignright")}, {
                    text: "Justify",
                    icon: "alignjustify",
                    onclick: Ti(i, "alignjustify")
                }];
            i.addMenuItem("align", {text: "Align", menu: e}), i.addButton("align", {
                type: "menubutton",
                icon: r,
                menu: e,
                ...
                i.addButton(t, {active: !1, tooltip: e[0], cmd: e[1], onPostRender: Si(i, t)})
            })
        }, Ni = function (e) {
            return e ? e.split(",")[0] : ""
        }, Pi = function (l, u) {
            ...
            e.addMenuItem("blockformats", {
                text: "Blocks", menu: (t = e, n = i, w.map(n, function (e) {
                    return {
                        text: e[0], onclick: Ti(t, e[1]), textStyle: function () {
            ...
            return Xi(o ? Yi(e, o) : (t = e, n = "insert", i = [{text: "-"}], r = w.grep(t.menuItems, function (e) {
                return e.context === n
            }), w.each(r, function (e) {
            ...
            n = e, w.each({
                ...
                n.addButton(t, {active: !1, tooltip: e, onPostRender: Si(n, t), onclick: Ti(n, t)})
            }), i = e, w.each({
                ...
                r.addButton(t, {active: !1, tooltip: e[0], cmd: e[1], onPostRender: Si(r, t)})
            })
        }, Gi = function (e) {
            var n;
            Ji(e), n = e, w.each({
            ...
            }), n.addMenuItem("codeformat", {text: "Code", icon: "code", onclick: Ti(n, "code")})
        }, Ki = function (n, i) {
            return function () {
            ...
            (t = e).addMenuItem("undo", {
                ...
                cmd: "undo"
            }), n.addButton("redo", {tooltip: "Redo", onPostRender: Ki(n, "redo"), cmd: "redo"})
        }, Qi = function (e) {
            var t, n;
            ...
            recalc: function (e) {
                var t, n, i, r, o, s, a, l, u, c, d, f, h, m, g, p, v, b, y, x, w, _, C, R, E, k, T, H, S = [], M = [];
                ...
                if (_ += p.left + p.right, C += p.top + p.bottom, (l = {}).minW = _ + (o.w - o.innerW), l.minH = C + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW === o.minW && l.minH === o.minH) {
                    ...
                    var P = 0, D = t.flexWidths;
                    if (D) for (d = 0; d < D.length; d++) P += D[d]; else P = i;
                    var W = k / P;
        ...
        }), dr = Kt.extend({Defaults: {classes: "radio", role: "radio"}}), fr = Wt.extend({
            renderHtml: function () {
                var e = this, t = e.classPrefix;
    ...
    var br = Wt.extend({
        init: function (e) {
            ...
            e = m._minValue, t = m._maxValue, "v" === m.settings.orientation ? (n = "screenY", i = "top", r = "height", o = "h") : (n = "screenX", i = "left", r = "width", o = "w"), m._super(), function (o, s) {
                function t(e) {
                    var t, n, i, r;
                    t = gr(t = (((t = m.value()) + (r = n = o)) / ((i = s) - r) + .05 * e) * (i - n) - n, o, s), m.value(t), m.fire("dragstart", {value: t}), m.fire("drag", {value: t}), m.fire("dragend", {value: t})
                }
                ...
                handle: m._id + "-handle",
                start: function (e) {
                    u = e[n], c = parseInt(m.getEl("handle").style[i], 10), d = (m.layoutRect()[o] || 100) - Ce.getSize(l)[r], m.fire("dragstart", {value: h})
                },
                drag: function (e) {
                    var t = e[n] - u;
                    f = gr(c + t, 0, d), l.style[i] = f + "px", h = s + f / d * (a - s), m.value(h), m.tooltip().text("" + m.settings.previewFilter(h)).show().moveRel(l, "bc tc"), m.fire("drag", {value: h})
                },
                stop: function () {
