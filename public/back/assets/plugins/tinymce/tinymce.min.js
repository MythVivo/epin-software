...
!function () {
    ...
    var e, t, n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v = function () {
        ...
        }, k = T("string"), _ = T("object"), R = T("array"), D = T("null"), B = T("boolean"), O = T("function"),
        P = T("number"), L = (o = Array.prototype.indexOf) === undefined ? function (e, t) {
            return X(e, t)
        } : function (e, t) {
            return o.call(e, t)
        }, I = function (e, t) {
    ...
    var fe, de, me, ge, pe, he, ve, be, ye, Ce, xe, we, Ne, Ee, Se, Te, ke, Ae, _e, Re = {
        ...
        }, setTimeout: Be, setInterval: Oe, setEditorTimeout: function (e, t, n) {
            return Be(function () {
                e.removed || t()
            }, n)
        ...
        b.bind = function (e, t, n, r) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                for (e[g] ? o = e[g] : (o = m++, e[g] = o, y[o] = {}), r = r || e, a = (t = t.split(" ")).length; a--;) c = d, s = l = !1, "DOMContentLoaded" === (u = t[a]) && (u = "ready"), b.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, qe({type: u})) : (h || (s = v[u]) && (c = function (e) {
                    var t, n;
    ...
    var $e = "sizzle" + -new Date, We = window.document, Ke = 0, Xe = 0, Ye = kt(), Ge = kt(), Je = kt(),
        Qe = function (e, t) {
            return e === t && (we = !0), 0
        }, Ze = typeof undefined, et = {}.hasOwnProperty, tt = [], nt = tt.pop, rt = tt.push, ot = tt.push,
        it = tt.slice, at = tt.indexOf || function (e) {
        ...
        dt = new RegExp("^" + ut + "*," + ut + "*"), mt = new RegExp("^" + ut + "*([>+~]|" + ut + ")" + ut + "*"),
        gt = new RegExp("=" + ut + "*([^\\]'\"]*?)" + ut + "*\\]", "g"), pt = new RegExp(lt),
        ht = new RegExp("^" + st + "$"), vt = {
            ID: new RegExp("^#(" + st + ")"),
            CLASS: new RegExp("^\\.(" + st + ")"),
            TAG: new RegExp("^(" + st + "|[*])"),
        ...
        }, bt = /^(?:input|select|textarea|button)$/i, yt = /^h\d$/i, Ct = /^[^{]+\{\s*\[native \w/,
        xt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, wt = /[+~]/, Nt = /'|\\/g,
        Et = new RegExp("\\\\([\\da-f]{1,6}" + ut + "?|(" + ut + ")|.)", "ig"), St = function (e, t, n) {
            var r = "0x" + t - 65536;
    ...
    for (de in me = Tt.support = {}, he = Tt.isXML = function (e) {
            ...
            TAG: function (e) {
                ...
                return 1 === g && 0 === p ? function (e) {
                    ...
                    if (l) {
                        ...
                        } else if (d && (r = (e[$e] || (e[$e] = {}))[m]) && r[0] === Ke) a = r[1]; else for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((b ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[$e] || (i[$e] = {}))[m] = [Ke, a]), i !== e));) ;
        ...
        pseudos: {
            not: At(function (e) {
                ...
                return t = t.replace(Et, St), function (e) {
                    return -1 < (e.textContent || e.innerText || pe(e)).indexOf(t)
                }
            }), lang: At(function (n) {
                return ht.test(n || "") || Tt.error("unsupported lang: " + n), n = n.replace(Et, St).toLowerCase(), function (e) {
                    var t;
                    do {
    ...
    function It(a, e, t) {
        var u = e.dir, s = t && "parentNode" === u, c = Xe++;
    ...
    function Ut(m, g, p, h, v, e) {
        return h && !h[$e] && (h = Ut(h)), v && !v[$e] && (v = Ut(v, e)), At(function (e, t, n, r) {
            var o, i, a, u = [], s = [], c = t.length, l = e || function (e, t, n) {
                    ...
                    return n
                }(g || "*", n.nodeType ? [n] : n, []), f = !m || !e && g ? l : Ft(l, u, m, n, r),
                d = p ? v || (e ? m : c || h) ? [] : t : f;
    ...
    function zt(e) {
        ...
        }]; u < o; u++) if (t = ge.relative[e[u].type]) l = [It(Mt(l), t)]; else {
            if ((t = ge.filter[e[u].type].apply(null, e[u].matches))[$e]) {
                for (n = ++u; n < o && !ge.relative[e[n].type]; n++) ;
                return Ut(1 < u && Mt(l), 1 < u && Lt(e.slice(0, u - 1).concat({value: " " === e[u - 2].type ? "*" : ""})).replace(ft, "$1"), t, u < n && zt(e.slice(u, n)), n < o && zt(e = e.slice(n)), n < o && Lt(e))
            }
            l.push(t)
        }
        return Mt(l)
    ...
    Pt.prototype = ge.filters = ge.pseudos, ge.setFilters = new Pt, ve = Tt.tokenize = function (e, t) {
        ...
        if (!a) {
            ...
            (a = Je(e, (h = i, b = 0 < (v = o).length, y = 0 < h.length, r = function (e, t, n, r, o) {
                var i, a, u, s = 0, c = "0", l = e && [], f = [], d = Ce, m = e || y && ge.find.TAG("*", o),
                    g = Ke += null == d ? 1 : Math.random() || .1, p = m.length;
    ...
    var Vt = Array.isArray, qt = function (e, t, n) {
            var r, o;
            if (!e) return 0;
            ...
            isArray: Vt, toArray: function (e) {
                var t, n, r = e;
                if (!Vt(e)) for (r = [], t = 0, n = e.length; t < n; t++) r[t] = e[t];
                return r
            }, each: qt, map: function (n, r) {
                var o = [];
            ...
            trim: Wt, isArray: jt.isArray, is: Kt, toArray: jt.toArray, makeMap: function (e, t, n) {
                var r;
        ...
        }, Gt = document, Jt = Array.prototype.push, Qt = Array.prototype.slice,
        Zt = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, en = je.Event, tn = Yt.makeMap("children,contents,next,prev"),
        nn = function (e) {
            return void 0 !== e
        }, rn = function (e) {
            ...
            var o;
            if (rn(t)) t = on(t, Cn(e[0])); else if (t.length && !t.nodeType) {
                if (t = pn.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) an(e, t[o], n, r); else for (o = 0; o < t.length; o++) an(e, t[o], n, r);
                return e
            }
        ...
        fn = {"for": "htmlFor", "class": "className", readonly: "readOnly"}, dn = {"float": "cssFloat"}, mn = {},
        gn = {}, pn = function (e, t) {
            return new pn.fn.init(e, t)
        }, hn = /^\s*|\s*$/g, vn = function (e) {
    ...
    pn.fn = pn.prototype = {
        constructor: pn, selector: "", context: null, length: 0, init: function (e, t) {
            var n, r, o = this;
            if (!e) return o;
            ...
            if (rn(e)) {
                ...
                if (n[1]) for (r = on(e, Cn(t)).firstChild; r;) Jt.call(o, r), r = r.nextSibling; else {
            ...
            if (!1 !== t) for (n = pn.unique(o.toArray().concat(pn.makeArray(e))), o.length = n.length, r = 0; r < n.length; r++) o[r] = n[r]; else Jt.apply(o, pn.makeArray(e));
            return o
        }, attr: function (t, n) {
            var e, r = this;
            ...
            if ("object" == typeof n) bn(n, function (e, t) {
                ...
                var e = this.style;
                if ((o = gn[n]) && o.set) o.set(this, r); else {
                    try {
                        this.style[dn[n] || n] = r
                    } catch (t) {
                    }
        ...
        }, push: Jt, sort: [].sort, splice: [].splice
    }, Yt.extend(pn, {
        extend: Yt.extend,
    ...
    var Sn = function (n) {
            ...
            nu: An, detect: function (e, t) {
                var n = String(t).toLowerCase();
                return 0 === e.length ? kn() : Tn(e, n)
            }, unknown: kn
        }, Rn = "Firefox", Dn = function (e, t) {
            return function () {
                return t === e
            }
        }, Bn = function (e) {
            ...
            firefox: H(Rn),
            safari: H("Safari")
        }, Pn = "Windows", Ln = "Android", In = "Solaris", Mn = "FreeBSD", Fn = function (e, t) {
            return function () {
                return t === e
            }
        }, Un = function (e) {
        ...
        }, Wn = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, Kn = function (t) {
            return function (e) {
                return jn(e, t)
            }
        }, Xn = [{
            ...
            name: "Chrome", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, Wn], search: function (e) {
        ...
        }, {name: "Opera", versionRegexes: [Wn, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: Kn("opera")}, {
            name: "Firefox",
            versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/],
            search: Kn("firefox")
        }, {
            name: "Safari", versionRegexes: [Wn, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
        ...
        }, {name: "Android", search: Kn("android"), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/]}, {
            name: "OSX",
            search: Kn("os x"),
            ...
            search: Kn("sunos"),
            versionRegexes: []
        }, {name: "FreeBSD", search: Kn("freebsd"), versionRegexes: []}], Gn = {browsers: H(Xn), oses: H(Yn)},
        Jn = function (e) {
            var t, n, r, o, i, a, u, s, c, l, f, d = Gn.browsers(), m = Gn.oses(), g = qn(d, e).fold(On.unknown, On.nu),
            ...
            fromHtml: function (e, t) {
                ...
                return Zn(n)
            }, fromDom: Zn, fromPoint: function (e, t, n) {
                var r = e.dom();
        ...
        }, ir = or(tr.ELEMENT), ar = or(tr.TEXT), ur = or(tr.DOCUMENT), sr = {
            name: nr, type: rr, value: function (e) {
                return e.dom().nodeValue
            }, isElement: ir, isText: ar, isDocument: ur, isComment: function (e) {
                return rr(e) === tr.COMMENT || "#comment" === nr(e)
            }
        }, cr = Object.keys, lr = function (e, t) {
            ...
            }, set: mr, setAll: function (e, t) {
                var n = e.dom();
                lr(t, function (e, t) {
                    dr(n, t, e)
                })
            }, get: gr, has: pr, remove: function (e, t) {
            ...
            body: vr, getBody: br, inBody: function (e) {
        ...
        }, Br = tr.ELEMENT, Or = tr.DOCUMENT, Pr = function (e) {
            ...
            eq: Ir, isEqualNode: function (e, t) {
                return e.dom().isEqualNode(t.dom())
            }, member: function (e, t) {
                return M(t, b(Ir, e))
            }, contains: Mr, is: Lr.is
        }, Ur = function (e) {
            var t = e.dom();
            ...
            owner: function (e) {
            ...
            }, parent: Ur, findIndex: function (n) {
                ...
                for (var n = O(t) ? t : H(!1), r = e.dom(), o = []; null !== r.parentNode && r.parentNode !== undefined;) {
                    var i = r.parentNode, a = er.fromDom(i);
            ...
            }, prevSibling: zr, offsetParent: function (e) {
                var t = e.dom();
                return A.from(t.offsetParent).map(er.fromDom)
            }, prevSiblings: function (e) {
                return t = Ar(e, zr), (n = Q.call(t, 0)).reverse(), n;
                var t, n
            }, nextSibling: Vr, nextSiblings: function (e) {
                return Ar(e, Vr)
            }, children: qr, child: Hr, firstChild: function (e) {
                return Hr(e, 0)
        ...
        }, Wr = Qn.detect().browser, Kr = function (e) {
            ...
            return {
                is: function (e) {
                    return n === e
                }, isValue: C, isError: y, getOr: H(n), getOrThunk: H(n), getOrDie: H(n), or: function (e) {
                    return to(n)
                }, orThunk: function (e) {
                    return to(n)
                }, fold: function (e, t) {
            ...
            return {
                is: y, isValue: y, isError: C, getOr: j, getOrThunk: function (e) {
                    return e()
                }, getOrDie: function () {
    ...
    var io, ao, uo, so = function (t) {
        ...
        }, Po = {trimNode: Oo}, Lo = Yt.makeMap,
        Io = /[&<>\"\u0060\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
        Mo = /[<>&\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g, Fo = /[<>&\"\']/g,
        Uo = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi, zo = {
            128: "\u20ac",
            130: "\u201a",
            131: "\u0192",
            132: "\u201e",
    ...
    var qo = function (e, t) {
            ...
            encodeRaw: qo, encodeAllRaw: function (e) {
                return ("" + e).replace(Fo, function (e) {
                    return ao[e] || e
                })
            }, encodeNumeric: Ho, encodeNamed: jo, getEncodeFunc: function (e, t) {
                var n = Vo(t) || io, r = Lo(e.replace(/\+/g, ","));
        ...
        }, Wo = {}, Ko = {}, Xo = Yt.makeMap, Yo = Yt.each, Go = Yt.extend, Jo = Yt.explode, Qo = Yt.inArray,
        Zo = function (e, t) {
            ...
            var u, t, n, r, o, i, s = {}, a = function (e, t, n) {
                ...
                var n, r, o, i;
                for (n = (e = Zo(e)).length, t = Zo(t); n--;) for (r = s[e[n]], o = 0, i = t.length; o < i; o++) r.attributes[t[o]] = {}, r.attributesOrder.push(t[o])
            };
            ...
            var r;
            return e && (r = {}, "string" == typeof e && (e = {"*": e}), Yo(e, function (e, t) {
    ...
    function ni(i) {
        ...
        var S = function (e) {
            ...
            var t, n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y,
                C = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
                x = /^([!\-])?(\w+[\\:]:\w+|[^=:<]+)?(?:([=:<])(.*))?$/, w = /[*?+]/;
            if (e) for (e = Zo(e, ","), N["@"] && (h = N["@"].attributes, v = N["@"].attributesOrder), t = 0, n = e.length; t < n; t++) if (i = C.exec(e[t])) {
                ...
                if (s) for (r = 0, o = (s = Zo(s, "|")).length; r < o; r++) if (i = x.exec(s[r])) {
            ...
            Wo[i.schema] = null, e && Yo(Zo(e, ","), function (e) {
                var t, n, r = o.exec(e);
                r && (n = r[1], t = n ? g[r[2]] : g[r[2]] = {"#comment": {}}, t = g[r[2]], Yo(Zo(r[3], "|"), function (e) {
                    "-" === n ? delete t[e] : t[e] = {}
                }))
            })
        }, w = function (e) {
        ...
        var r = {}, i = window, o = {}, t = 0, e = function (m, e) {
                ...
                var v = function (e) {
                    ...
                    if (e = Yt._addCacheSuffix(e), h[e] ? a = h[e] : (a = {
                        ...
                        if (a.status = 1, (o = m.createElement("link")).rel = "stylesheet", o.type = "text/css", o.id = "u" + p++, o.async = !1, o.defer = !1, i = (new Date).getTime(), "onload" in o && !((d = navigator.userAgent.match(/WebKit\/(\d*)/)) && parseInt(d[1], 10) < 536)) o.onload = l, o.onerror = s; else {
            ...
            }(a), l = [], f = u.schema ? u.schema : ni({}),
            d = oi({url_converter: u.url_converter, url_converter_scope: u.url_converter_scope}, u.schema),
            m = u.ownEvents ? new je(u.proxy) : je.Event, n = f.getBlockElements(),
            ...
            }, B = $o.decode, O = $o.encodeAllRaw, P = function (e, t) {
                var n = h(e);
    ...
    var pi = gi, hi = pi.DOM, vi = Yt.each, bi = Yt.grep, yi = function (e) {
    ...
    var Ei = function (t, n) {
        ...
        }, append: Si, appendAt: function (e, t, n) {
        ...
        return Ii(e, "class", t)
    }, zi = Mi, Vi = Fi, qi = Ui, Hi = function (e, t) {
    ...
    var Yi, Gi = function (e, t, n) {
            ...
            first: function (e) {
                return Qi(yr.body(), e)
            }, ancestor: Gi, closest: function (e, t, n) {
        ...
        }, oa = H("mce-annotation"), ia = H("data-mce-annotation"), aa = H("data-mce-annotation-uid"),
        ua = function (r, e) {
            var t = r.selection.getRng(), n = er.fromDom(t.startContainer), o = er.fromDom(r.getBody()),
                i = e.fold(function () {
                    return "." + oa()
                }, function (e) {
                    return "[" + ia() + '="' + e + '"]'
                }), a = $r.child(n, t.startOffset).getOr(n), u = ra(a, i, function (e) {
                    return Fr.eq(e, o)
                }), s = function (e, t) {
            ...
            var n, r, o, a = Bi({}), c = function (e, t) {
                ...
                var n = a.get(), r = t(n.hasOwnProperty(e) ? n[e] : {listeners: [], previous: Bi(A.none())});
                n[e] = r, a.set(n)
            }, t = (n = function () {
                var e, t, n, r = a.get(), o = (e = cr(r), (n = Q.call(e, 0)).sort(t), n);
                F(o, function (e) {
                    u(e, function (u) {
            ...
            var t, n
        }, Ia = Do.isContentEditableTrue, Ma = Do.isContentEditableFalse, Fa = Do.isBr, Ua = Do.isText,
        za = Do.matchNodeNames("script style textarea"),
        Va = Do.matchNodeNames("img input textarea hr iframe video audio object"), qa = Do.matchNodeNames("table"),
        Ha = Aa, ja = function (e) {
        ...
        }, ou = Do.isElement, iu = ja, au = Do.matchStyleValues("display", "block table"),
        uu = Do.matchStyleValues("float", "left right"), su = ya.and(ou, iu, ya.negate(uu)),
        cu = ya.negate(Do.matchStyleValues("white-space", "pre pre-line pre-wrap")), lu = Do.isText, fu = Do.isBr,
        du = pi.nodeIndex, mu = eu, gu = function (e) {
            ...
            if (ou(e.container())) if (e.isAtEnd()) n = mu(e.container(), e.offset()), lu(n) && i(n, n.data.length), su(n) && !fu(n) && o(Cu(yu(n), !1)); else {
    ...
    function wu(t, n, e) {
        ...
        return {
            container: ya.constant(t), offset: ya.constant(n), toRange: function () {
                var e;
    ...
    var Nu, Eu, Su = wu, Tu = Do.isText, ku = Do.isBogus, Au = pi.nodeIndex, _u = function (e) {
        ...
        return r.insertNode(l), Mu(l.previousSibling), e.moveToBookmark({id: o, keep: 1}), {id: o}
    }, $u = {
        getBookmark: function (e, t, n) {
            ...
            }) : t ? {rng: e.getRng()} : ju(e, !1);
            var r, o
        }, getUndoBookmark: b(qu, j, !0), getPersistentBookmark: ju
        ...
        var r = qc(1, e.getBody(), t), o = Su.fromRangeStart(r), i = o.getNode();
    ...
    var fs, ds, ms = Do.isContentEditableFalse, gs = Do.isText, ps = Do.isElement, hs = Do.isBr, vs = ja,
        bs = function (e) {
    ...
    var Es, Ss, Ts, ks, As, _s = function (e, t) {
        ...
        }, Ps = b(Rs, wu.isAbove, -1), Ls = b(Rs, wu.isBelow, 1), Is = b(Ds, -1, Ps), Ms = b(Ds, 1, Ls),
        Fs = function (e, t, n, r, o) {
            ...
            if (u = {elm: t, alignToTop: n}, e.fire("scrollIntoView", u), !u.isDefaultPrevented() && Do.isElement(t)) {
        ...
        Sc = Do.matchStyleValues("display", "block table table-cell table-caption list-item"), Tc = Aa, kc = Ta,
        Ac = ya.curry, _c = Do.isElement, Rc = ja, Dc = function (e) {
            return 0 < e
        }, Bc = function (e) {
            return e < 0
        }, Oc = function (e, t) {
            ...
            fromPosition: tl, nextPosition: b(tl, !0), prevPosition: b(tl, !1), navigate: function (t, n, r) {
                return tl(t, n, r).bind(function (e) {
                    return Ic(r, e, n) && el(t, r, e) ? tl(t, n, e) : A.some(e)
                })
            }, positionIn: nl, firstPositionIn: b(nl, !0), lastPositionIn: b(nl, !1)
        }, ol = function (e, t) {
            ...
            isInlineBlock: gl, moveStart: function (e, t, n) {
                var r, o, i, a = n.startOffset, u = n.startContainer;
                if ((n.startContainer !== n.endContainer || !gl(n.startContainer.childNodes[n.startOffset])) && 1 === u.nodeType) for (a < (i = u.childNodes).length ? r = new oo(u = i[a], e.getParent(u, e.isBlock)) : (r = new oo(u = i[i.length - 1], e.getParent(u, e.isBlock))).next(!0), o = r.current(); o; o = r.next()) if (3 === o.nodeType && !pl(o)) return n.setStart(o, 0), void t.setRng(n)
            }, getNonWhiteSpaceSibling: function (e, t, n) {
                if (e) for (t = t ? "nextSibling" : "previousSibling", e = n ? e : e[t]; e; e = e[t]) if (1 === e.nodeType || !pl(e)) return e
            ...
            }, isWhiteSpaceNode: pl, replaceVars: function (e, n) {
            ...
            }, normalizeStyleValue: hl, getStyle: function (e, t, n) {
            ...
            for (a = new oo(n, e.getParent(n, e.isBlock) || t); u = a[o ? "prev" : "next"]();) if (3 === u.nodeType) {
                if (-1 !== (s = El(o, i, c = u))) return {container: u, offset: s}
            } else if (e.isBlock(u)) break;
            if (c) return {container: c, offset: r = o ? 0 : c.length}
        }, Tl = function (e, t, n, r, o) {
            var i, a, u, s;
            for (3 === r.nodeType && 0 === r.nodeValue.length && r[o] && (r = r[o]), i = yl(e, r), a = 0; a < i.length; a++) for (u = 0; u < t.length; u++) if (!("collapsed" in (s = t[u]) && s.collapsed !== n.collapsed) && e.is(i[a], s.selector)) return i[a];
            return r
        }, kl = function (t, e, n, r) {
            ...
            if (o && e[0].wrapper && (o = yl(i, o, "ul,ol").reverse()[0] || o), !o) for (o = n; o[r] && !i.isBlock(o[r]) && (o = o[r], !vl.isEq(o, "br"));) ;
            return o || n
            ...
            for (; ;) {
                ...
                for (c = s[l]; c; c = c[l]) if (!bl(c) && !Cl(c) && ("BR" !== (d = c).nodeName || !d.getAttribute("data-mce-bogus") || d.nextSibling)) return s;
            ...
            var i, a, u = o.uid,
                ...
                c = Ll(o, ["uid"]), l = [], f = er.fromTag("span");
            Wi.add(f, oa()), hr.set(f, "" + aa(), s), hr.set(f, "" + ia(), t);
            var d = n(s, c), m = d.attributes, g = void 0 === m ? {} : m, p = d.classes, h = void 0 === p ? [] : p;
            hr.setAll(f, g), da(f, h);
            var v = Bi(A.none()), b = function () {
                v.set(A.none())
            }, y = function (e) {
                F(e, C)
            }, C = function (e) {
            ...
            a.undoManager.transact(function () {
                ...
                r.collapsed && (n = _l(e = a, t = r, [{inline: !0}], !1), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t));
                var o = $u.getPersistentBookmark(a.selection, !0), i = a.selection.getRng();
    ...
    function Fl(s) {
        ...
        return {
            register: function (e, t) {
                ...
                var t, n, r, o, i, a,
                    u = (t = s, n = e, r = er.fromDom(t.getBody()), o = Ki(r, "[" + ia() + '="' + n + '"]'), i = {}, F(o, function (e) {
                        var t = hr.get(e, aa()), n = i.hasOwnProperty(t) ? i[t] : [];
                        i[t] = n.concat([e])
                    }), i);
                return a = function (e) {
                    return $(e, function (e) {
    ...
    var Ul = function (e) {
        ...
        var n = Su.after(e), r = Ns(t).prev(n);
        ...
        var n, r, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, x, w,
            ...
            E = ql(o, i.startContainer), S = Vl(Ul(N.firstChild)), T = o.getRoot(), k = function (e) {
                var t = Su.fromRangeStart(i), n = Ns(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
    ...
    var nf = function (a) {
            var u = Su.fromRangeStart(a), s = Su.fromRangeEnd(a), c = a.commonAncestorContainer;
        ...
        }, of = Do.matchNodeNames("td th"), af = function (o, e, t) {
            ...
            if (/^ | $/.test(e) && (e = function (e) {
            ...
            }(e)), n = o.parser, g = t.merge, r = tf({validate: o.settings.validate}, o.schema), m = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', s = {
                content: e,
                format: "html",
                selection: !0,
                paste: t.paste
                ...
                var E, S, T, k = {context: (i = h.getNode()).nodeName.toLowerCase(), data: t.data, insert: !0};
        ...
        }, sf = kr("sections", "settings"), cf = Qn.detect().deviceType.isTouch(), lf = ["lists", "autolink", "autosave"],
        ff = {theme: "mobile"}, df = function (e) {
            var t = R(e) ? e.join(" ") : e, n = $(k(t) ? t.split(" ") : [], $n);
            ...
            var o, i = df(n.forced_plugins), a = df(r.plugins), u = e && gf(t, "mobile") ? U(a, b(I, lf)) : a,
            ...
            return ru([rl.firstPositionIn(u), rl.lastPositionIn(u)], function (e, t) {
                var n = wf.normalizePosition(!0, e), r = wf.normalizePosition(!1, t), o = wf.normalizePosition(!1, a);
            ...
            var n
        }, _f = Do.hasAttribute("data-mce-bookmark"), Rf = Do.hasAttribute("data-mce-bogus"),
        Df = Do.hasAttributeValue("data-mce-bogus", "all"), Bf = function (e) {
            return function (e) {
                var t, n, r = 0;
                if (Af(e, e)) return !1;
                ...
                t = new oo(n, e);
                do {
                    if (Df(n)) n = t.next(!0); else if (Rf(n)) n = t.next(); else if (Do.isBr(n)) r++, n = t.next(); else {
                        if (Af(e, n)) return !1;
                        n = t.next()
                    }
                } while (n);
        ...
        }, Of = kr("block", "position"), Pf = kr("from", "to"), Lf = function (e, t) {
            var n = er.fromDom(e), r = er.fromDom(t.container());
            return Nf(n, r).map(function (e) {
                return Of(e, t)
            })
        }, If = function (o, i, e) {
            var t = Lf(o, Su.fromRangeStart(e)), n = t.bind(function (e) {
            ...
            var n = er.fromDom(t), r = b(Fr.eq, e);
        ...
        }, ed = Zf([{remove: ["element"]}, {moveToElement: ["element"]}, {moveToPosition: ["position"]}]),
        td = function (e, t, n, r) {
            var o = r.getNode(!1 === t);
            ...
            var r, a, o, i = cd(n, t.getBody(), e.dom()), u = Zi.ancestor(e, b(fd, t), (r = t.getBody(), function (e) {
                return e.dom() === r
            ...
            return Do.isContentEditableTrue(n) && e.dom.isBlock(n) && e.dom.isEmpty(n) && (t = e.dom.create("br", {"data-mce-bogus": "1"}), e.dom.setHTML(n, ""), n.appendChild(t), e.selection.setRng(Su.before(t).toRange())), !0
        }, bd = Do.isText, yd = function (e) {
        ...
        }, Nd = b(wd, !0), Ed = b(wd, !1), Sd = function (e, t) {
            ...
            return A.none()
        }, _d = Zf([{before: ["element"]}, {start: ["element"]}, {end: ["element"]}, {after: ["element"]}]),
        Rd = function (e, t) {
            var n = Lc(t, e);
            return n || e
        }, Dd = function (e, t, n) {
            var r = wf.normalizeForwards(n), o = Rd(t, r.container());
            ...
            var r = wf.normalizeBackwards(n), o = Rd(t, r.container());
            return wf.findRootInline(e, o, r).fold(function () {
            ...
            var e = wf.normalizePosition(a, c), l = Fd(u, s, e);
        ...
        }, Wd = Fd, Kd = $d, Xd = (b($d, !1), b($d, !0), Vd), Yd = function (e) {
            ...
            var n = t.selection.getRng(), r = e ? Su.fromRangeEnd(n) : Su.fromRangeStart(n);
            ...
            }, moveNextWord: b(rm, !0), movePrevWord: b(rm, !1), setupSelectedState: function (a) {
                var u = Bi(null), s = b(wf.isInlineTarget, a);
            ...
            var u = r.getBody(), s = b(wf.isInlineTarget, r);
            ...
            var e, t, a = (e = n.getBody(), t = o.container(), Lc(t, e) || e), u = b(wf.isInlineTarget, n), s = Wd(u, a, o);
            return s.bind(function (e) {
                ...
                var t = rl.navigate(i, a, o), e = t.bind(function (e) {
                    return Wd(u, a, e)
                });
                return s.isSome() && e.isSome() ? wf.findRootInline(u, a, o).map(function (e) {
                    return o = e, !!ru([rl.firstPositionIn(o), rl.lastPositionIn(o)], function (e, t) {
                        var n = wf.normalizePosition(!0, e), r = wf.normalizePosition(!1, t);
            ...
            return !1
        }, cm = kr("start", "end"), lm = kr("rng", "table", "cells"),
        fm = Zf([{removeTable: ["element"]}, {emptyCells: ["cells"]}]), dm = function (e, t) {
            ...
            var t = dm(e.startContainer, r), n = dm(e.endContainer, r);
            ...
            getFontSize: $m("font-size"), getFontFamily: q(function (e) {
                return e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")
            }, $m("font-family")), toPt: function (e, t) {
            ...
            for (var r = new oo(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot()); t = r[n ? "prev" : "next"]();) if (Do.isBr(t)) return !0
            ...
            var n = t.collapsed, r = t.cloneRange(), o = wu.fromRangeStart(t);
            ...
            "LI" !== d || m || (l = f), s && 3 === s.nodeType && u >= s.nodeValue.length && (function (e, t, n) {
                for (var r, o = new oo(t, n), i = e.getNonEmptyElements(); r = o.next();) if (i[r.nodeName.toLowerCase()] || 0 < r.length) return !0
            ...
            var n, r, o,
                i = (n = e, r = b(wf.isInlineTarget, n), o = Su.fromRangeStart(n.selection.getRng()), Wd(r, n.getBody(), o).filter(fg));
            i.isSome() ? i.each(b(dg, e)) : ag(e, t)
        }, gg = Zf([{before: ["element"]}, {on: ["element", "offset"]}, {after: ["element"]}]),
        pg = (gg.before, gg.on, gg.after, function (e) {
            return e.fold(j, j, j)
        }),
        hg = Zf([{domRange: ["rng"]}, {relative: ["startSitu", "finishSitu"]}, {exact: ["start", "soffset", "finish", "foffset"]}]),
        vg = kr("start", "soffset", "finish", "foffset"), bg = {
            domRange: hg.domRange, relative: hg.relative, exact: hg.exact, exactFromRange: function (e) {
                return hg.exact(e.start(), e.soffset(), e.finish(), e.foffset())
            }, range: vg, getWin: function (e) {
                var t = e.match({
                    domRange: function (e) {
        ...
        }, yg = Qn.detect().browser, Cg = function (e, t) {
        ...
        }, Lg = Yt.each, Ig = Yt.extend, Mg = Yt.map, Fg = Yt.inArray;
    ...
    function Ug(s) {
        ...
        e({
            "mceResetDesignMode,mceBeginUndoLevel": function () {
                ...
                var r, o;
                o = n, (r = s).formatter.toggle("fontname", {value: Ym(r, o)}), r.nodeChanged()
            }, FontSize: function (e, t, n) {
                var r, o;
                o = n, (r = s).formatter.toggle("fontsize", {value: Ym(r, o)}), r.nodeChanged()
    ...
    var qg, Hg = function (n) {
            ...
            fire: function (e, t, n) {
                ...
                if (t = Hg(this).fire(e, t, n), !1 !== n && this.parent) for (var r = this.parent(); r && !t.isPropagationStopped();) r.fire(e, t, !1), r = r.parent();
                return t
            }, on: function (e, t, n) {
            ...
            var e, t;
            if (i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed) if (e = tp(i, a), i.settings.event_root) {
        ...
        }, ip = op = Yt.extend({}, jg, op), ap = Yt.each, up = Yt.explode, sp = {f9: 120, f10: 121, f11: 122},
    ...
    var fp = function (e) {
        ...
        }, Ep = b(wp, "clientWidth"), Sp = b(wp, "clientHeight"), Tp = b(Np, "margin-top"), kp = b(Np, "margin-left"),
        Ap = function (e, t, n) {
            var r, o, i, a, u, s, c, l, f, d, m = er.fromDom(e.getBody()), g = e.inline ? m : $r.documentElement(m),
    ...
    var Bp = Ni.PluginManager, Op = function (e, t) {
        var n = function (e, t) {
    ...
    }, zp = Ni.PluginManager, Vp = Ni.ThemeManager;
    ...
    function Hp(u, s) {
        ...
        return s = Yt.extend({credentials: !1, handler: n}, s), {
            upload: function (e, t) {
    ...
    }, Jp = Xp, Qp = 0, Zp = function (e) {
        return (e || "blobid") + Qp++
    }, eh = function (n, r, o, t) {
        var i, a;
        0 !== r.src.indexOf("blob:") ? (i = Jp(r.src).data, (a = n.findFirst(function (e) {
            return e.base64() === i
        })) ? o({image: r, blobInfo: a}) : Yp(r.src).then(function (e) {
            a = n.create(Zp(), e, i), n.add(a), o({image: r, blobInfo: a})
        }, function (e) {
            t(e)
        })) : (a = n.getByUri(r.src)) ? o({image: r, blobInfo: a}) : Yp(r.src).then(function (t) {
            Gp(t).then(function (e) {
                i = Jp(e).data, a = n.create(Zp(), t, i), n.add(a), o({image: r, blobInfo: a})
            })
        }, function (e) {
            t(e)
        })
    ...
    var ih = function (e, t) {
        ...
        if (f = d.forced_root_block, v && Do.isElement(v) && f && (l = b.nodeName.toLowerCase(), p.isValidChild(l, f.toLowerCase()) && (y = h, C = b, x = v, !M(zf(er.fromDom(x), er.fromDom(C)), function (e) {
            ...
            var y, C, x, w, N;
            for (n = (t = g.getRng()).startContainer, r = t.startOffset, o = t.endContainer, i = t.endOffset, c = xp(e), v = b.firstChild; v;) if (w = h, N = v, Do.isText(N) || Do.isElement(N) && !ih(w, N) && !ml(N)) {
                if (ah(h, v)) {
        ...
        return ru([(i = e, a = i.startContainer, u = i.startOffset, Do.isText(a) ? 0 === u ? A.some(er.fromDom(a)) : A.none() : A.from(a.childNodes[u]).map(er.fromDom)), (t = e, n = t.endContainer, r = t.endOffset, Do.isText(n) ? r === n.data.length ? A.some(er.fromDom(n)) : A.none() : A.from(n.childNodes[r - 1]).map(er.fromDom))], function (e, t) {
            var n = V(ch(o), b(Fr.eq, e)), r = V(lh(o), b(Fr.eq, t));
            return n.isSome() && r.isSome()
        }).getOr(!1);
        var t, n, r, i, a, u
    }, dh = function (e, t, n, r) {
        var o = n, i = new oo(n, o), a = e.schema.getNonEmptyElements();
        do {
    ...
    var ph, hh, vh = function (e) {
        ...
        t = pi.DOM, a = document, n = wh(c, e), p = c, h = e, v = Le.throttle(function (e, t) {
            ...
            if (p.dragging) {
                var g = (f = p, {pageX: (d = bh(h, e)).pageX - f.relX, pageY: d.pageY + 5});
    ...
    }, _h = b(Ah, ph.Up, Ja, Qa), Rh = b(Ah, ph.Down, Qa, Ja), Dh = function (n) {
        return function (e) {
            return t = n, e.line > t;
            var t
        }
    ...
    }, Oh = Do.isContentEditableFalse, Ph = Pc, Lh = function (e, t) {
    ...
    }, jh = Do.isContentEditableTrue, $h = Do.isContentEditableFalse, Wh = Xc, Kh = Kc, Xh = function (e, t) {
        ...
        return Re.ceFalse && (function () {
            ...
            var n, r, i = function (e, t) {
                ...
                return !(!o || !g.dom.isChildOf(o, i) || !1 !== $h(Xh(g, o))) || o && (n = o, r = i, !(g.dom.getParent(n, g.dom.isBlock) === g.dom.getParent(r, g.dom.isBlock))) && function (e) {
                    ...
                    var n = Su.before(e.firstChild), r = t.next(n);
                    return r && !Kh(r) && !Wh(r)
                }(o)
            };
            r = !1, (n = g).on("touchstart", function () {
                ...
                var t, n = e.target;
                if ((n === a || "HTML" === n.nodeName || g.dom.isChildOf(n, a)) && !1 !== Ap(g, e.clientX, e.clientY)) if (t = Xh(g, n)) $h(t) ? (e.preventDefault(), c(ss(g, t))) : (l(), jh(t) && e.shiftKey || Vh(e.clientX, e.clientY, g.selection.getRng()) || (C(), g.selection.placeCaretAt(e.clientX, e.clientY))); else if (!1 === Nc(n)) {
                    l(), C();
    ...
    function Jh(F, U) {
        ...
        var z = F.comment ? F.comment : e, V = F.cdata ? F.cdata : e, q = F.text ? F.text : e,
        ...
        return {
            parse: function (e) {
                ...
                for (S = new RegExp("<(?:(?:!--([\\w\\W]*?)--\x3e)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), T = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, s = U.getShortEndedElements(), E = F.self_closing_elements || U.getSelfClosingElements(), g = U.getBoolAttrs(), p = F.validate, u = F.remove_internals, _ = F.fix_self_closing, k = U.getSpecialElements(), N = e + ">"; t = S.exec(N);) {
                    if (R < t.index && q(O(e.substr(R, t.index - R))), n = t[6]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), I(n); else if (n = t[7]) {
                        ...
                        c || (v && v.indexOf("/") === v.length - 1 ? f && j(n) : D.push({name: n, valid: f}))
    ...
    var Qh = Jh, Zh = function (e, t) {
        ...
        return Na(l)
    }, ev = {trimExternal: Zh, trimInternal: Zh}, tv = 0, nv = 2, rv = 1, ov = function (g, p) {
    ...
    }, fv = lv, dv = function (e, t) {
        var n = $r.owner(e).dom(), r = er.fromDom(n.createDocumentFragment()), o = cv(t, n);
        Ai(r, o), Ri.empty(e), Ti.append(e, r)
    }, mv = Bi(A.none()), gv = function (e) {
        ...
        "fragmented" === t.type ? sv(t.fragments, e.getBody()) : e.setContent(t.content, {format: "raw"}), e.selection.moveToBookmark(n ? t.beforeBookmark : t.bookmark)
    }, Cv = function (e, t) {
    ...
    function xv(u) {
        ...
        return u.on("init", function () {
            ...
            data: l, typing: !1, beforeChange: function () {
                ...
                var e;
                return o.typing && (o.add(), o.typing = !1, i(!1)), 0 < c && (e = l[--c], yv(u, e, !0), d(!0), u.fire("undo", {level: e})), e
            }, redo: function () {
                var e;
                return c < l.length - 1 && (e = l[++c], yv(u, e, !1), d(!0), u.fire("redo", {level: e})), e
            }, clear: function () {
    ...
    var wv, Nv, Ev = vl.isEq, Sv = function (e, t, n) {
        ...
        } else for (s = 0; s < c.length; s++) if ("attributes" === r ? e.getAttrib(t, c[s]) : vl.getStyle(e, t, c[s])) return n;
        return n
    }, _v = function (e, t, n, r, o) {
        var i, a, u, s, c = e.formatter.get(n), l = e.dom;
        if (c && t) for (a = 0; a < c.length; a++) if (i = c[a], kv(e.dom, t, i) && Av(l, t, i, "attributes", o, r) && Av(l, t, i, "styles", o, r)) {
            if (s = i.classes) for (u = 0; u < s.length; u++) if (!e.dom.hasClass(t, s[u])) return;
            return i
        }
    }, Rv = {
        matchNode: _v, matchName: kv, match: function (e, t, n, r) {
            var o;
            ...
            if (u) for (n = e.selection.getStart(), r = vl.getParents(s, n), i = u.length - 1; 0 <= i; i--) {
        ...
        var t;
        if (e) for (e = (t = new oo(e, e)).current(); e; e = t.next()) if (3 === e.nodeType) return e;
        return null
    }, Mv = function (e) {
        ...
        if (r) Fv(t, n, r, o); else if (!(r = Xu(e, n.getStart()))) for (; r = t.get(Pv);) Fv(t, n, r, !1)
    }, zv = function (e, t, n) {
        var r = e.dom, o = r.getParent(n, ya.curry(vl.isTextBlock, e));
    ...
    var Xv = function (e, t) {
    ...
    }, Yv = /^(src|href|style)$/, Gv = Yt.each, Jv = vl.isEq, Qv = function (e) {
        ...
        if ("all" !== n.remove) for (Gv(n.styles, function (e, t) {
    ...
    }, rb = nb, ob = function (s, c, l, e, f) {
        var t, n, d = s.formatter.get(c), m = d[0], a = !0, u = s.dom, r = s.selection, o = function (e) {
            var n, t, r, o, i, a,
                u = (n = s, t = e, r = c, o = l, i = f, Gv(vl.getParents(n.dom, t.parentNode).reverse(), function (e) {
                    var t;
            ...
            return function (e, t, n, r, o, i, a, u) {
                ...
                if (n) {
                    for (m = n.parentNode, s = r.parentNode; s && s !== m; s = s.parentNode) {
                        for (c = g.clone(s, !1), d = 0; d < t.length; d++) if (nb(e, t[d], u, c, c)) {
                            c = 0;
                            break
                        }
            ...
            var t, n, r, o, i;
            if (Do.isElement(e) && u.getContentEditable(e) && (o = a, a = "true" === u.getContentEditable(e), i = !0), t = Yt.grep(e.childNodes), a && !i) for (n = 0, r = d.length; n < r && !nb(s, d[n], l, e, e); n++) ;
            if (m.deep && t.length) {
            ...
            if (e = _l(s, e, d, !0), m.split) {
                if ((t = Zv(s, e, !0)) !== (n = Zv(s, e))) {
                    ...
                    t = eb(u, t, "span", {id: "_start", "data-mce-type": "bookmark"}), n = eb(u, n, "span", {
                        id: "_end",
                        "data-mce-type": "bookmark"
                    }), o(t), o(n), t = i(!0), n = i()
                } else t = n = o(t);
        ...
        if (e) e.nodeType ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), p(n)) : p(e); else if ("false" !== u.getContentEditable(r.getNode())) r.isCollapsed() && m.inline && !u.select("td[data-mce-selected],th[data-mce-selected]").length ? function (e, t, n, r) {
            ...
            if (c) if (u) {
                ...
                l = Xu(e.getBody(), c);
                var h = Mv(!1).dom(), v = qv(m, h);
                zv(e, h, l || c), Fv(f, d, l, !1), d.setCursorLocation(v, 1), f.isEmpty(c) && f.remove(c)
            }
        }(s, c, l, f) : (t = $u.getPersistentBookmark(s.selection, !0), p(r.getRng()), r.moveToBookmark(t), m.inline && Rv.match(s, c, l, r.getStart()) && vl.moveStart(u, r, r.getRng()), s.nodeChanged()); else {
            e = r.getNode();
            for (var h = 0, v = d.length; h < v && (!d[h].ceFalseOverride || !nb(s, d[h], l, e, e)); h++) ;
        }
    }, ib = Yt.each, ab = function (e) {
    ...
    }, Cb = Yt.each, xb = function (g, p, h, r) {
            ...
            y = function (n, e) {
                ...
                l = b.inline || b.block, f = s.create(l), y(f), Dl(s, e, function (e) {
                    var a, u = function (e) {
                        ...
                        if (b.wrapper && Rv.matchNode(g, e, p, h)) a = 0; else {
        ...
        if ("false" !== i.getContentEditable(n.getNode())) {
            if (b) {
                if (r) r.nodeType ? C(v, r) || ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, _l(g, t, v), 0, !0)) : a(i, r, 0, !0); else if (o && b.inline && !i.select("td[data-mce-selected],th[data-mce-selected]").length) !function (e, t, n) {
    ...
    }, wb = {applyFormat: xb}, Nb = Yt.each, Eb = function (e, t, n, r, o) {
        var i, a, u, s, c, l, f, d;
        null === t.get() && (a = e, u = {}, (i = t).set({}), a.on("NodeChange", function (n) {
            var r = vl.getParents(a.dom, n.element), o = {};
    ...
    }, Tb = Yt.each, kb = pi.DOM, Ab = function (e, t) {
        var n, o, r, m = t && t.schema || ni({}), g = function (e) {
            ...
            if (u = d, s = "string" != typeof (a = n) ? a.nodeName.toLowerCase() : a, c = m.getElementRule(s), i = !(!(l = c && c.parentsRequired) || !l.length) && (u && -1 !== Yt.inArray(l, u) ? u : l[0])) d === i ? (o = e[0], e = e.slice(1)) : o = i; else if (f) o = e[0], e = e.slice(1); else if (!t) return n;
        ...
        return e && "string" == typeof e ? (e = (e = e.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), Yt.map(e.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
            var t = Yt.map(e.split(/(?:~\+|~|\+)/), _b), n = t.pop();
    ...
    var Lb, Ib = Object.prototype.hasOwnProperty, Mb = (Lb = function (e, t) {
            ...
            process: function (e, t, n) {
                ...
                }), o = "BODY" !== o.nodeName ? u.body.firstChild : u.body, s = c.doc, c.doc = u), $g(r, Mb(i, {node: o})), s && (c.doc = s), o) : t;
        ...
        jb = {"#text": 3, "#comment": 8, "#cdata": 4, "#pi": 7, "#doctype": 10, "#document-fragment": 11},
        $b = function (e, t, n) {
    ...
    function ry(T, k) {
        ...
        var B = function (e) {
            ...
            schema: k, addAttributeFilter: function (e, n) {
                ey(ty(e), function (e) {
                    var t;
                ...
                var g = k.getNonEmptyElements(), p = k.children, h = T.validate,
                    v = "forced_root_block" in a ? a.forced_root_block : T.forced_root_block,
                    b = k.getWhiteSpaceElements(), y = /^[ \t\r\n]+/, C = /[ \t\r\n]+$/, x = /[ \t\r\n]+/g,
                    w = /^[ \t\r\n]+$/;
                ...
                if (t.parse(e), h && m.length && (a.context ? a.invalid = !0 : function (e) {
                    ...
                    for (d = Zb("tr,td,th,tbody,thead,tfoot,table"), l = k.getNonEmptyElements(), f = k.getWhiteSpaceElements(), m = k.getTextBlockElements(), g = k.getSpecialElements(), t = 0; t < e.length; t++) if ((n = e[t]).parent && !n.fixed) if (m[n.name] && "li" === n.parent.name) {
    ...
    var oy = function (e, t, n) {
        ...
        var r = n.selection ? Mb({forced_root_block: !1}, n) : n, o = e.parse(t, r);
        return Fb.trimTrailingBr(o), o
    }, uy = function (e, t, n, r, o) {
        var i, a, u, s, c = (i = r, tf(t, n).serialize(i));
        return a = e, s = c, !(u = o).no_events && a ? Wg(a, Mb(u, {content: s})).content : s
    };

    function sy(e, t) {
        var a, u, s, c, l, n,
            r = (a = e, n = ["data-mce-selected"], s = (u = t) && u.dom ? u.dom : pi.DOM, c = u && u.schema ? u.schema : ni(a), a.entity_encoding = a.entity_encoding || "named", a.remove_trailing_brs = !("remove_trailing_brs" in a) || a.remove_trailing_brs, l = ry(a, c), Fb.register(l, a, s), {
                schema: c,
                addNodeFilter: l.addNodeFilter,
                addAttributeFilter: l.addAttributeFilter,
                serialize: function (e, t) {
                    var n = Mb({format: "html"}, t || {}), r = Ub.process(u, e, n), o = iy(s, r, n), i = ay(l, o, n);
    ...
    var ly = cy, fy = Do.isContentEditableFalse, dy = Do.isContentEditableTrue, my = function (r, a) {
        var u, s, c, l, f, d, m, g, p, h, v, b, i, y, C, x, w, N = a.dom, E = Yt.each, S = a.getDoc(), T = document,
            k = Math.abs, A = Math.round, _ = a.getBody();
    ...
    }, by = kr("element", "width", "rows"), yy = kr("element", "cells"), Cy = kr("x", "y"), xy = function (e, t) {
        ...
        for (var n = e.rows(), r = 0; r < n.length; r++) for (var o = n[r].cells(), i = 0; i < o.length; i++) if (Fr.eq(o[i], t)) return A.some(Cy(i, r));
        return A.none()
        ...
        return (t = e, n = o[0], ta(n, "table", b(Fr.eq, t))).bind(function (e) {
            var t = o[0], n = o[o.length - 1], r = Sy(e);
        ...
        var n, t, l, f, a, r = function (e, t) {
            ...
            getSelectedBlocks: function (e, t) {
                return function (e, t, n, r) {
                    var o, i, a = [];
                    if (i = e.getRoot(), n = e.getParent(n || My(i, t, t.collapsed), e.isBlock), r = e.getParent(r || Fy(i, t, t.collapsed), e.isBlock), n && n !== i && a.push(n), n && r && n !== r) for (var u = new oo(o = n, i); (o = u.next()) && o !== r;) e.isBlock(o) && a.push(o);
    ...
    }, jy = Do.isContentEditableFalse, $y = Za, Wy = Xc, Ky = Kc, Xy = function (e, t) {
        ...
        return function () {
            var e, t, n, r, o, i, a, u, s,
                c = (t = f, r = Ns((e = l).getBody()), o = ya.curry(Xy, r.next), i = ya.curry(Xy, r.prev), a = t ? Nu.Forwards : Nu.Backwards, u = t ? o : i, s = e.selection.getRng(), (n = Yy(a, e, u, s)) ? n : (n = Jy(e, a, s)) || null);
            return !!c && (l.selection.setRng(c), !0)
        }
    }, Zy = function (u, s) {
        return function () {
            var e, t, n, r, o, i,
                a = (r = (t = s) ? 1 : -1, o = t ? Rh : _h, i = (e = u).selection.getRng(), (n = Gy(r, e, o, i)) ? n : (n = Jy(e, r, i)) || null);
            return !!a && (u.selection.setRng(a), !0)
        }
    }, eC = function (e, r) {
        return G($(e, function (e) {
            return Mb({shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: v}, e)
        }), function (e) {
        ...
        i.on("keydown", function (e) {
            ...
            !1 === e.isDefaultPrevented() && (t = i, n = a, r = e, o = Qn.detect().os, nC([{
                keyCode: Hh.RIGHT,
                action: Qy(t, !0)
            }, {keyCode: Hh.LEFT, action: Qy(t, !1)}, {keyCode: Hh.UP, action: Zy(t, !1)}, {
                keyCode: Hh.DOWN,
                action: Zy(t, !0)
            }, {keyCode: Hh.RIGHT, action: bc(t, !0)}, {keyCode: Hh.LEFT, action: bc(t, !1)}, {
                keyCode: Hh.UP,
                action: yc(t, !1)
            }, {keyCode: Hh.DOWN, action: yc(t, !0)}, {keyCode: Hh.RIGHT, action: om.move(t, n, !0)}, {
                keyCode: Hh.LEFT,
        ...
        o.on("keydown", function (e) {
            ...
            !1 === e.isDefaultPrevented() && (t = o, n = i, r = e, nC([{
                ...
                keyCode: Hh.BACKSPACE,
                action: tC(uC, t, !1)
            }, {keyCode: Hh.DELETE, action: tC(uC, t, !0)}], r).each(function (e) {
                r.preventDefault()
            }))
            ...
            !1 === e.isDefaultPrevented() && (t = o, n = e, nC([{
                keyCode: Hh.BACKSPACE,
                action: tC(vd, t)
            }, {keyCode: Hh.DELETE, action: tC(vd, t)}], n))
        })
    }, cC = function (e) {
        ...
        if (n !== e.getBody()) {
            ...
            if (bC(n, r, !0) && bC(n, r, !1)) pC(n, "LI") ? i.insertAfter(l, vC(n)) : i.replace(l, n); else if (bC(n, r, !0)) pC(n, "LI") ? (i.insertAfter(l, vC(n)), l.appendChild(i.doc.createTextNode(" ")), l.appendChild(n)) : n.parentNode.insertBefore(l, n); else if (bC(n, r, !1)) i.insertAfter(l, vC(n)); else {
                n = vC(n);
                var f = a.cloneRange();
        ...
        var t, u, s, i, c, n, r, o, l, f, d, m, g, p, h, v, b, y, C = a.dom, x = a.schema, w = x.getNonEmptyElements(),
            N = a.selection.getRng(), E = function (e) {
                ...
                if (e || "TABLE" === f || "HR" === f ? (t = C.create(e || m), SC(a, t)) : t = c.cloneNode(!1), r = t, !1 === oc(a)) C.setAttrib(t, "style", null), C.setAttrib(t, "class", null); else do {
                    if (i[o.nodeName]) {
                        if (Ku(o)) continue;
        ...
        }(C, w, r), p = C, (h = c).normalize(), (v = h.lastChild) && !/^(left|right)$/gi.test(p.getStyle(v, "float", !0)) || p.add(h, "br"), C.isEmpty(c) && CC(c), r.normalize(), C.isEmpty(r) ? (C.remove(r), T()) : lC(a, r)), C.setAttrib(r, "id", ""), a.fire("NewBlock", {newBlock: r})))
    }, kC = function (e, t) {
        ...
        return kC(e, rc(e))
    }, RC = Zf([{br: []}, {block: []}, {none: []}]), DC = function (e, t) {
        return _C(e)
    }, BC = function (n) {
        return function (e, t) {
            return "" === ec(e) === n
        ...
        var t = ec(e), n = fC(e.dom, e.selection.getStart());
    ...
    function QC(u) {
        var s, n, r, o = Yt.each, c = Hh.BACKSPACE, l = Hh.DELETE, f = u.dom, d = u.selection, e = u.settings,
            t = u.parser, i = Re.gecko, a = Re.ie, m = Re.webkit, g = "data:text/mce-internal,", p = a ? "Text" : "URL",
            h = function (e, t) {
                try {
    ...
    var ZC = function (e) {
            ...
            t.on("click", function (e) {
                3 <= e.detail && function (e) {
                    var t = e.selection.getRng(), n = wu.fromRangeStart(t), r = wu.fromRangeEnd(t);
        ...
        }, nx = pi.DOM, rx = function (e) {
            var t;
            e.bindPendingEventDelegates(), e.initialized = !0, e.fire("init"), e.focus(!0), e.nodeChanged({initial: !0}), e.execCallback("init_instance_callback", e), (t = e).settings.auto_focus && Le.setEditorTimeout(t, function () {
                var e;
            ...
            !function (e, t, n, r) {
                ...
                e = u, (n = (t = i).settings).language && "en" !== n.language && !n.language_url && (n.language_url = t.editorManager.baseURL + "/langs/" + n.language + ".js"), n.language_url && !t.editorManager.i18n.data[n.language] && e.add(n.language_url), r = i.settings, o = a, Yt.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), Yt.each(r.external_plugins, function (e, t) {
                    ...
                    if ((e = Yt.trim(e)) && !zp.urls[e]) if (hx(e)) {
                    ...
                    } else zp.load(e, {prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js"})
        ...
        }, Cx = Yt.each, xx = Yt.trim,
        wx = "source protocol authority userInfo user password host port relative path directory file query anchor".split(" "),
        Nx = {ftp: 21, http: 80, https: 443, mailto: 25}, Ex = function (r, e) {
            var t, n, o = this;
            if (r = xx(r), t = (e = o.settings = e || {}).base_uri, /^([\w\-]+):([^\/]{2})/i.test(r) || /^\s*#/.test(r)) o.source = r; else {
                var i = 0 === r.indexOf("//");
    ...
    Ex.prototype = {
        setPath: function (e) {
            ...
            var t;
            if ("./" === e) return e;
            if ("mce_host" !== (e = new Ex(e, {base_uri: this})).host && this.host !== e.host && e.host || this.port !== e.port || this.protocol !== e.protocol && "" !== e.protocol) return e.getURI();
            ...
            return (e = new Ex(e, {base_uri: this})).getURI(t && this.isSameOrigin(e))
    ...
    var Sx = function (e, t, n) {
        var r, o, i, a, u;
        if (t.format = t.format ? t.format : "html", t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) r = Yt.trim(ev.trimExternal(e.serializer, n.innerHTML)); else if ("text" === t.format) r = Na(n.innerText || n.textContent); else {
        ...
        e.dom.setHTML(e.getBody(), t), xp(r = e) && rl.firstPositionIn(r.getBody()).each(function (e) {
            var t = e.getNode(), n = Do.isTable(t) ? rl.firstPositionIn(t).getOr(e) : e;
        ...
        if (!e.removed) {
            ...
            r && e.save({is_removing: !0}), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && o && Dx.remove(o.nextSibling), !e.inline && r && (i = e, Dx.setStyle(i.id, "display", i.orgDisplay)), Kg(e), e.editorManager.remove(e), Dx.remove(e.getContainer()), Bx(t), Bx(n), e.destroy()
        }
        var i
    }, Px = function (e, t) {
    ...
    }, Lx = pi.DOM, Ix = Yt.extend, Mx = Yt.each, Fx = Yt.resolve, Ux = Re.ie, zx = function (e, t, n) {
    ...
    Ix(zx.prototype = {
        render: function () {
            ...
            r.contextToolbars = r.contextToolbars || [], "string" == typeof e && (n = e, e = function (e) {
                return r.dom.is(e, n)
            }), r.contextToolbars.push({id: rh.uuid("mcet"), predicate: e, items: t})
            ...
            t && (e = Ix({content: e}, t)), this.execCommand("mceInsertContent", !1, e)
        }, isDirty: function () {
    ...
    var Vx, qx, Hx, jx = {
            ...
            Wx(t), t.on("focusin", function () {
                ...
                t = e.target, n && t.ownerDocument === document && (t === document.body || Yx(n, t) || r.focusedEditor !== n || (n.fire("blur", {focusedEditor: null}), r.focusedEditor = null))
        ...
        }, nw = pi.DOM, rw = Yt.explode, ow = Yt.each, iw = Yt.extend, aw = 0, uw = !1, sw = [], cw = [],
        lw = function (t) {
    ...
    iw(Hx = {
        ...
        setup: function () {
            var e, t, n, r, o = "";
            if (t = Ex.getDocumentBaseUrl(document.location), /^[^:]+:\/\/\/?[^\/]+\//.test(t) && (t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(t) || (t += "/")), n = window.tinymce || window.tinyMCEPreInit) e = n.base || n.baseURL, o = n.suffix; else {
        ...
        init: function (r) {
            ...
            var c = function (e) {
                ...
                nw.unbind(window, "ready", e), function (e) {
                    var t = r[e];
        ...
        add: function (e) {
            var t = this;
            return sw[e.id] === e || (null === t.get(e.id) && ("length" !== e.id && (sw[e.id] = e), sw.push(e), cw.push(e)), fw(!0), t.activeEditor = e, t.fire("AddEditor", {editor: e}), qx || (qx = function () {
                t.fire("BeforeUnload")
        ...
        remove: function (e) {
            var t, n, r = this;
            if (e) {
                if (!k(e)) return n = e, D(r.get(n.id)) ? null : (dw(n) && r.fire("RemoveEditor", {editor: n}), 0 === cw.length && nw.unbind(window, "beforeunload", qx), n.remove(), fw(0 < cw.length), n);
    ...
    var hw, vw, bw = pw, yw = Math.min, Cw = Math.max, xw = Math.round, ww = function (e, t, n) {
        ...
        }, relativePosition: ww, findBestRelativePosition: function (e, t, n, r) {
            var o, i;
            for (i = 0; i < r.length; i++) if ((o = ww(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
            return null
        ...
        }, create: Nw, fromClientRect: function (e) {
        ...
        add: function (e, t) {
            ...
            var t = e.toLowerCase(), n = Sw.hasOwnProperty(t) ? Sw[t] : null;
    ...
    _w.extend = hw = function (n) {
        var e, t, r, o = this.prototype, i = function () {
            var e, t, n;
            if (!vw && (this.init && this.init.apply(this, arguments), t = this.Mixins)) for (e = t.length; e--;) (n = t[e]).init && n.init.apply(this, arguments)
        }, a = function () {
            return this
        }, u = function (n, r) {
            return function () {
    ...
    var Rw = Math.min, Dw = Math.max, Bw = Math.round, Ow = function (e, n) {
        var r, o, t, i;
        ...
        callbacks: {}, count: 0, send: function (t) {
            var n = this, r = pi.DOM, o = t.count !== undefined ? t.count : n.count, i = "tinymce_jsonp_" + o;
        ...
        send: function (e) {
            ...
            if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", Iw.fire("beforeInitialize", {settings: e}), t = new qp) {
    ...
    qw.sendRPC = function (e) {
        ...
        send: function (n) {
            ...
            (n = Vw(this.settings, n)).success = function (e, t) {
                void 0 === (e = Pw.parse(e)) && (e = {error: "JSON Parse error."}), e.error ? r.call(n.error_scope || n.scope, e.error, t) : o.call(n.success_scope || n.scope, e.result)
    ...
    Hw = Ww, window.tinymce = Hw, window.tinyMCE = Hw, function (e) {
