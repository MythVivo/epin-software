...
<div class=page-container>
    ...
    <div class="message">
        <h1>Buraya başlık gelecektir.</h1>

        <p>Buraya gövde metni gelecektir. Buraya gövde metni gelecektir. Buraya gövde metni gelecektir. Buraya gövde
            metni gelecektir.</p>

        <div class="button-container">
            <a class="btn-inline color-yellow" href="{{route('active', [$email, $token])}}">Şifreyi yenile</a>
        </div>
    </div>
