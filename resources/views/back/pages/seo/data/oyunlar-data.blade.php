<?php
    $oyun = DB::table('games')->where('id', $id)->first();
    ?>
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                <form id="pageSave" method="post" action="{{route(('seo_yonetim_oyun_meta_save'))}}">
                    @csrf
                    <div class="row">
                        <div class="col-6">
            ...
            <div class="col-md-6">
                <a class="searchResult">
                    <span>{{env('APP_URL')}}oyun/<t class="text-danger" id="pageLink">{{$oyun->link}}</t> </span>
