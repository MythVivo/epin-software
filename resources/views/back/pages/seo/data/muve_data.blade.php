<?php
$oyun = DB::table('muve_games')->where('id', $id)->first();
?>
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                <form id="pageSave" method="post" action="{{route(('seo_yonetim_muve_meta_save'))}}">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" class="form-control" rows="3">{{$oyun->metaDescription}}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
            ...
            <div class="col-md-6">
                <a class="searchResult">
                    <span>{{env('APP_URL')}}cd-key-detay/<t class="text-danger" id="pageLink">{{$oyun->link}}</t> </span>
                    <h3 id="pageTitle">{{$oyun->title}}</h3>
                    <p id="pageDesc">{{$oyun->metaDescription}}</p>
                </a>
