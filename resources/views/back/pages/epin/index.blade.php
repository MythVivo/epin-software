...
if(@$_GET['c_id']){
    echo "<pre>";$r=0;
    foreach(DB::table('epin_satis_kodlar')->where('epin_satis', $_GET['c_id'])->get() as $a){$r++;
        echo $r."- ".epin::DEC($a->code)."\n";
    }
    die("</pre>");
}
...
@section('css')
    ...
    <style>
        ...
        .swal2-html-container{
            max-height: 26em;  /* To be adjusted as you like */
            overflow-y: scroll;
            width: 100%;
        }
    </style>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('.goster').click(function(x){
            let id=$(this).attr('id').split('_')[1];
            $.get('?', {c_id:id}, function (x) {
                swal.fire({html: x });
            });
