            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title mb-3">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 text-left">
                                @lang('admin.sssKategoriYonetimi')
                            </div>
                            <div class="col-md-6 col-sm-6 text-right">
                                <button type="button" class="btn btn-outline-primary waves-effect waves-light" onclick="location.href='{{route('sss')}}'">@lang('admin.sssYonetimi')</button>
                                <button type="button" class="btn btn-outline-success waves-effect waves-light"
                                        data-toggle="modal" data-target=".ekle">@lang('admin.sssKategoriEkle')</button>
                            </div>
                        </div>
                    </h4>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title mt-0" id="myModalLabel">@lang('admin.sssKategoriEkle')</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X
                                    </button>
                                </div>
                                <form id="yeniEkle" method="post" action="{{route('sss_kategori_add')}}" enctype="multipart/form-data">
                                    @csrf
                                    {!! getLangInput() !!}
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="title" type="text" class="form-control" id="1"
                                                           placeholder="@lang('admin.sssKategoriBasligi')">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="table-responsive">
                        {{view('back.pages.faq.category.table')}}
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
