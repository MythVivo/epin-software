<?php
if (isset($_GET['sil'])) {
   DB::table('icons')->where('id', $_GET['sil'])->update(['deleted_at' => date('YmdHis')]);
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 text-right">
                                <button type="button" class="btn btn-outline-success waves-effect waves-light"
                                        data-toggle="modal" data-target=".ekle">Yeni İkon Ekle
                                </button>
                            </div>
                        </div>
                    </h4>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title mt-0" id="myModalLabel">Yeni İkon Ekle</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X
                                    </button>
                                </div>
                                <form id="yeniEkle" method="post" action="{{route('ikon_add')}}"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="2">Başlık</label>
                                                    <input id="2" type="text" name="title" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="3">İkon</label>
                                                    <input id="3" type="text" name="icon" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
