                                ...
                                <div class="altBaslik float-left">
                                    <a href="javascript:void(0)" data-toggle="modal"
                                       data-target=".tradeDuzenle{{$uu->id}}">
                                        ...
                                        : @if($toplamSatisTutar > 0 && $toplamSatisAdet>0) {{substr($toplamSatisTutar / $toplamSatisAdet, 0, 6)}} @else
                                        ...
                                        : @if($toplamAlisSayi > 0 && $toplamAlisTutar>0) {{substr($toplamAlisTutar / $toplamAlisAdet, 0, 6)}} @else
                                        ...
                                        <form id="duzenle" method="post" action="{{route('oyun_paket_trade_edit')}}"
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label for="444">Promosyon (Küçükten büyüğe doğru adet/oran:)</label>
                                                            <input name="indirim" type="text" title="100/5  (100 adet alımda %5 indirim anlamına gelir) Birden fazla için : kullanın. Küçükten büyüğe doğru oranları giriniz." placeholder="100/5:200/7 gibi" class="form-control" id="444" value="{{$uu->indirim}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" data-toggle="modal" data-target=".topluGB"
                                    class="btn btn-block btn-outline-success">Toplu GB Güncelleme
                                                            ...
                                                            {{--                                        yakup mauel ekle çıkar olayı iptal--}}
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            @foreach(\App\Models\GamesPackagesTrade::where('games_titles', $u->id)->get() as $uu)
                                                ...
                                                $toplamSatisAdet = $toplamSatislar->sum('adet');
                                                $toplamSatisTutar = $toplamSatislar->sum('price');
                                                if ($toplamSatisSayi > 0 && $toplamSatisTutar>0) {
                                                ...
                                                $toplamAlisAdet = $toplamAlislar->sum('adet');
                                                $toplamAlisTutar = $toplamAlislar->sum('price');
                                                if ($toplamAlisSayi > 0 && $toplamAlisTutar>0) {
