                                            ...
                                            <div class="price-tck">
                                                ...
                                                @endif
                                                    ...
                                                    <button type="button" class="btn-inline color-blue small"
                                                            ...
                                                            <?  // Bu oyun panelden satışa kapalıysa buton pasif

                                                            $oyun=DB::select("select kapat from oyun_siparis where oyun='$epin->game'")[0]->kapat;
                                                            if($oyun==1) {echo ">Stok Yok</button>";}   // oyun genel olarak satışa kapalıysa
                                                            else {
                                                            if($u->kapat=='1') {echo ">Stok Yok</button>";} // oyun paketi satışa kapalıysa
                                                            else{
                                                            ?> onclick="location.href='{{route('epin_detay_paket_satin_al', [$epin->link, Str::slug($u->title).'-'.$u->id])}}?adet=1'"> Satın Al</button> <?
                                                }
                                                }
