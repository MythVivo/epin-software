...
<head>
    ...
    <title>E-posta ile Giriş Yap  | {{getSiteName()}}</title>
                ...
                <div class="form-wrapper">
                    <div class="row">
                        ...
                        <div class="form-container">
                            ...
                            @endif
                            <form method="post" action="{{route('fa_auth_post', $user->login_token)}}">
                                <div class="row">
                                    @csrf
                                    @if(isset($_COOKIE['redirect']))
                                    ...
                                    <div class="col-12 text-center mt-3">
                                        <span>Bu e-postaya erişiminiz yok mu?</span>
                                        <div class="button-register">
                                            <?php $sms = "2fa_sms"; $google = "2fa_google"; ?>
                                            @if($user->$google == 1)
                                                <a href="{{route('fa_auth_google', $user->login_token)}}">Google OTP İle
                                                    Oturum
                                                    Aç</a>
                                            @endif
                                            @if($user->$google == 1 and $user->$sms == 1)
                                                <span> - veya - </span>
                                            @endif
                                            @if($user->$sms == 1)
                                                <a href="{{route('fa_auth_sms', [$user->login_token, 1])}}">Sms İle
                                                    Oturum
                                                    Aç</a>
                                            @endif
                                        </div>
