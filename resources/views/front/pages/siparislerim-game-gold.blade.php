                                    ...
                                    <table id="datatable" class="table table-hover table-striped ">
                                        ...
                                        @foreach($siparisler->get() as $u)
                                            <tr>
                                                ...
                                                <td @if($u->tur == "bize-sat" and $u->status == 0) class="blink islemDurumu"
                                                    @endif data-id="{{$u->id}}">
                                                    @if($u->tur == "bize-sat")
                                                        @if($u->notx)
                                                        {!! findGameGoldStatus($u->status, "bize-sat", $u->notx) !!}
                                                        @elseif($u->teslim_nick)
                                                    ...
                                                    @else
                                                        @if($u->notx)
                                                            {!! findGameGoldStatus($u->status, "bizden-al", $u->notx) !!}
                                                        @else
