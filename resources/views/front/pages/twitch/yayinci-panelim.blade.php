            ...
            <div class="row">
                ...
                <div class="col-md-9">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" id="userinput1" class="form-control border-radius-20"
                                            name="date1" value="{{ date('Y-m-d', strtotime('-5 days')) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-5">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" id="userinput2" class="form-control border-radius-20"
                                            name="date2" value="{{ date('Y-m-d') }}" required>
                                    </div>
                                </div>
                            </div>

                            <div class="col-sm-12 col-md-2">
                                <button type="submit" class="btn-inline color-blue w-100">Sorgula</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card border-radius-20 mb-4">
                                <div class="card-body">
                                    <h5 class="card-title mb-0">
                                        {{ 'Biriken Bağış Bakiyeniz : ' . Auth::user()->bagis_bakiye . ' TL' }}
                                        <button class="btn-inline color-darkgreen ms-2"
                                            onclick="location.href='{{ route('twitch_support_yayinci_bakiye_cevir') }}'">
                                            Bakiye Çevir
                                        </button>
                    ...
                    <div class="row">
                        ...
                        $yayincilar = DB::table('twitch_support_streamer')
                            ->where('user', Auth::user()->id)
                            ->first();
                        
                        $streamer = DB::table('twitch_support_donates')
                            ->whereDate('created_at', '>=', $date1)
                            ->whereDate('created_at', '<=', $date2)
                            ->where('streamer', $yayincilar->id)
                            ...
                            <div class="col-12">
                                ...
                                <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center"
                                    ...
                                    <h5>
                                        ...
                                        Henüz bir bağış almamışsınız. İlk bağışınızdan sonra burada bağışlarınız
