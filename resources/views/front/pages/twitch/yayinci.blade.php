...
@section('head')
    <meta name="description" content="{{$yayinci}} Destekle">
    <meta name="keywords" content="{{$yayinci}} Destekle">
@endsection
@section('css')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 ">
                                                    <h5 class="card-title text-end"><i
                                                                ...
                                                                class="bakiye2">{{Auth::user()->bakiye+Auth::user()->bakiye_cekilebilir}}</span> TL
                                                    </h5>
                                                </div>
                                                <div class="col-12">
                                                    <hr>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="1" type="text" class="form-control style-input"
                                                               ...
                                                               <div class="invalid-feedback">
                                                                Harflerden veya rakamlardan oluşan bir isim giriniz.
                                                            </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="destek" type="number" step="0.01"
                                                               ...
                                                               name="amount" max="{{Auth::user()->bakiye+Auth::user()->bakiye_cekilebilir}}" required>
                                                        <div class="invalid-feedback">
                                                            Lütfen geçerli bir tutar girin
                                                            (Minimum {{$yayinciDB->min_bagis}} TL,
                                                            Maksimum {{Auth::user()->bakiye+Auth::user()->bakiye_cekilebilir}} TL)
                                                        </div>
                                                    </div>
                                                </div>
