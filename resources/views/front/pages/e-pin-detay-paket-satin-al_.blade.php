                                    ...
                                    */ ?>
                                        ...
                                        <td>
                                            <div class="decrement">
                                                ...
                                                <input name="adet" class="input-number" type="number" value="{{$adet}}"
                                                       min="1" max="{{$stok}}">
                                            ...
                                            @if(isset(Auth::user()->id))
                                                @if(Auth::user()->bakiye >= $fiyat)
                                                    @if($adet > $stok)
                                                        <?php /*
                                                    @if($epin->epin != 0)
                                                        @if($adet > $stokSorgu->MaxQtyPerOrder or $adet > $paket->stok)
                                                            <div class="alert alert-danger fade show d-flex align-items-center"
                                                                 role="alert">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <h5>
                                                                            Satın Alma işlemi için tek seferde izin
                                                                            verilen
                                                                            maksimum sayının üstündesiniz veya yeterli
                                                                            stok
                                                                            yok,
                                                                            lütfen miktarı düşürün veya stokların
                                                                            güncellenmesi
                                                        ...
                                                        @else
                                                            <form method="post" action="{{route('epin_satin_al')}}">
                                                                @csrf
                                                                <input type="hidden" name="baslik"
                                                                       value="{{$epin->id}}">
