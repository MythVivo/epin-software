                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(isset(Auth::user()->id))
                                            {{MF(Auth::user()->bakiye+Auth::user()->bakiye_cekilebilir)}} TL
                                        @else
                                    ...
                                    <td>
                                        @if(isset(Auth::user()->id))
                                            @if(Auth::user()->bakiye+Auth::user()->bakiye_cekilebilir - $u->price < 0)
                                                İşlem için yeterli bakiyeniz yok
                                            @else
                                                {{Auth::user()->bakiye+Auth::user()->bakiye_cekilebilir - $u->price}} TL
                                            @endif
                                        @else
                                            Bakiyenizi Görmek İçin Giriş Yapın
                                        @endif
                                ...
                                <div class="confirmation card text-center mt-100 mb-100">
                                    <div class="card-body">
                                        @if($u->status == 1 && $u->userStatus==1)
                                            ...
                                            @if(isset(Auth::user()->id))
                                                @if(Auth::user()->bakiye+Auth::user()->bakiye_cekilebilir >= $u->price)
                                                    <form method="post" action="{{route('ilan_satin_al')}}">
                                                        @csrf
                                                        <input type="hidden" name="ilan" value="{{$u->id}}">
                                                        <label for="note" class="form-label">Teslim edilecek karakter adı</label><br>
                                                        <input id="note" type="text" class="form-control style-input"
                                                               name="note"
                                                               placeholder="Teslim edilecek karakter adı" required>
                                                        <button type="submit"
                                        ...
                                        @else
                                            <div class="alert alert-danger fade show d-flex align-items-center"
                                                 role="alert">
                                                <h5>Bu ilan satılmış yada yayında değil !</h5>
                                            </div>
                                        @endif
