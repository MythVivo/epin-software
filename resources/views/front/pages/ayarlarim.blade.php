        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @if(session('error'))
                    ...
                    <div class="row">
                        <form class="needs-validation" action="{{route('ayarlarim_post')}}" method="POST"
                            ...
                            <ul class="nav nav-pills custom-nav mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-genel-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-genel" type="button" role="tab"
                                            aria-controls="pills-genel"
                                            aria-selected="true">Genel
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-guvenlik-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-guvenlik" type="button" role="tab"
                                            aria-controls="pills-guvenlik" aria-selected="false">Güvenlik
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-bildirim-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-bildirim" type="button" role="tab"
                                            aria-controls="pills-bildirim" aria-selected="false">Bildirimler
                                    </button>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-genel" role="tabpanel"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <img class="img w-100 img-fluid img-thumbnail"
                                                 src="{{asset('/public/front/avatars/'.Auth::user()->avatar)}}">
                                            <button type="button" class="btn-inline color-blue mt-3 w-100"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#avatarSec">
                                                Yeni Avatar Seç
                                            </button>
                                            <div class="modal fade" id="avatarSec" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            ?>
                                                            @foreach($files as $f)
                                                                @if($f->getFilename() != "." and $f->getFilename() != ".." and $f->isDir() )
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                                ...
                                                                                @foreach($filesSub as $ff)
                                                                                    @if($ff != "." and $ff != "..")
                                                                                        <div class="col-4 col-md-2 mb-5">
                                                                                            <a class="avatar-thumbnail-select"
                                                                                               href="{{route('avatar_sec', [$f, $ff])}}">
                                                                                                <img class="avatar-thumbnail"
                                                                                                     src="{{asset('/public/front/avatars/'.$f.'/'.$ff)}}">
                                                                                            </a>
                                                                                        </div>
                                                                                    @endif
                                                                                @endforeach
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-4">
                                                    <label for="1" class="form-label">Ad Soyad</label>
                                                    <input type="text" name="name" class="form-control style-input"
                                                           id="1"
                                                           value="{{Auth::user()->name}}" required
                                                           @if(getUserVerifiyStep(Auth::user()->id) > 2) readonly @endif>
                                                    <div class="invalid-feedback">
                                                        Lütfen adınızı ve soyadınızı girin.
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-4">
                                                    <label for="222" class="form-label">Telefon</label>
                                                    <div class="input-group has-validation">
                                                        <select id="countryCode"
                                                                data-selected-id="{{Auth::user()->telefon_country}}"
                                                                class="form-control" name="telefon_country">
                                                            <option data-countryCode="TR" value="90">Türkiye (+90)
                                                            </option>
                                                        ...
                                                        <input value="{{Auth::user()->telefon}}"
                                                               name="telefon" autocomplete="off"
                                                               class="form-control style-input" id="222" required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-4 mb-4">
                                                    <label for="3" class="form-label">T.C. No</label>
                                                    <input type="number" name="tcno" class="form-control style-input"
                                                           id="3" min="10000000000"
                                                           max="99999999999"
                                                           value="{{Auth::user()->tcno}}" required
                                                           @if(getUserVerifiyStep(Auth::user()->id) > 2) readonly @endif>
                                                    <div class="invalid-feedback">
                                                        Lütfen geçerli bir TC No Girin
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-4">
                                                    <?php
                                                    $emailFirst = strstr(Auth::user()->email, '@', true); //"username"
                                                    ?>
                                                    <label for="33" class="form-label">Email</label>
                                                    <input type="text" class="form-control"
                                                           id="33"
                                                           value="{{substr($emailFirst, 0, 2)}}******@***{{substr(Auth::user()->email, -7)}}"
                                                           required disabled>
                                                </div>
                                                <div class="col-md-4 mb-4">
                                                    <label for="4" class="form-label">Doğum Tarihi</label>
                                                    <input type="date" class="form-control style-input" id="4" required
                                                           value="{{Auth::user()->dogum_tarihi}}" name="dogum_tarihi"
                                                           @if(Auth::user()->tc_verified_at_first != NULL) readonly @endif>
                                                    <div class="invalid-feedback">
                                                        Lütfen Geçerli Bir Tarih Girin
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-4">
                                                    <label for="5" class="form-label">Cinsiyetiniz</label>
                                                    <select name="cinsiyet" class="form-select style-select" id="5"
                                                            required>
                                                        <option selected disabled value="">Cinsiyet...</option>
                                                        <option value="1"
                                                                @if(Auth::user()->cinsiyet == 1) selected @endif>
                                                            Erkek
                                                        </option>
                                                        <option value="2"
                                                                @if(Auth::user()->cinsiyet == 2) selected @endif>
                                                            Kadın
                                                        </option>
                                                    </select>
                                                    <div class="invalid-feedback">
                                ...
                                <div class="tab-pane fade" id="pills-guvenlik" role="tabpanel"
                                     aria-labelledby="pills-guvenlik-tab">

                                    <div class="row g-3">

                                        <div class="col-md-4">
                                            <label for="6" class="form-label">Eski Şifreniz</label>
                                            <input type="password" name="password_old" class="form-control style-input"
                                                   id="6">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4">
                                            <label for="7" class="form-label">Yeni Şifreniz</label>
                                        ...
                                        <div class="col-md-4">
                                            <label for="8" class="form-label">Yeni Şifrenizi Tekrarlayın</label>
                                            <input type="password" name="password_rewrite"
                                                   class="form-control style-input" id="8">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check form-switch">
                                                <label for="9" class="form-check-label">SMS İle Giriş</label>
                                                <?php
                                                $name = "2fa_sms";
                                                ?>
                                                <input name="2fa_sms" id="9" class="form-check-input" type="checkbox"
                                                       @if(Auth::user()->telefon_verified_at == NULL) disabled @endif
                                                       @if(Auth::user()->$name == 1) checked @endif @if(Auth::user()->telefon_country != "90") disabled @endif>
                                                <div class="switcher"><span><i></i></span></div>
                                                @if(Auth::user()->telefon_verified_at == NULL) <br> <small
                                                        class="text-danger">SMS ile giriş için lütfen telefon numaranızı
                                                    doğrulayın.</small>@endif
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-check form-switch">
                                                <label for="10" class="form-check-label">Email İle Giriş</label>
                                                <?php
                                                $name = "2fa_email";
                                                ?>
                                                <input name="2fa_email" id="10" class="form-check-input" type="checkbox"
                                                       @if(Auth::user()->email_verified_at == NULL) disabled @endif
                                                       @if(Auth::user()->$name == 1) checked @endif>
                                                <div class="switcher"><span><i></i></span></div>
                                                @if(Auth::user()->email_verified_at == NULL) <br> <small
                                                        class="text-danger">Email ile giriş için lütfen e-posta
                                                    adresinizi doğrulayın.</small>@endif
                                            </div>
                                        </div>

                                        <?php
                                        $googleApp = getGoogleAuth();
                                        ?>
                                        <div class="col-md-4">
                                            <div class="form-check form-switch">
                                                <label for="authenticator" class="form-check-label">Google
                                                    Authenticator</label>
                                                <?php
                                                $name = "2fa_google";
                                                ?>
                                                <input onchange="googleAc()" name="2fa_google" id="authenticator"
                                                       class="form-check-input" type="checkbox"
                                                       @if(Auth::user()->$name == 1) checked
                                                       @endif @if(!isset($googleApp['ManualSetupCode'])) disabled @endif>
                                                <div class="switcher"><span><i></i></span></div>
                                            </div>
                                            @if(!isset($googleApp['ManualSetupCode']))
                                                <small class="text-danger">Google OTP Servislerine erişilemiyor bir süre
                                                    sonra tekrar deneyin.</small>
                                            @endif
                                        </div>

                                        <div class="col-12" id="authenticator_image"
                                             @if(Auth::user()->$name == 1)  style="display: block;"
                                             @else style="display: none; @endif">
                                            <?php

                                            if (isset($googleApp['ManualSetupCode'])) {
                                                $ManualSetupCode = $googleApp['ManualSetupCode'];
                                                $googleAppHtml = $googleApp["Html"];
                                            } else {
                                                $ManualSetupCode = "Servislere erişilemiyor bir süre sonra tekrar deneyin.";
                                                $googleAppHtml = "Servislere erişilemiyor bir süre sonra tekrar deneyin.";
                                            }
                                            ?>

                                            <article>
                                                <input type="hidden" name="googleSecret"
                                                       value="{{$ManualSetupCode}}">
                                                <h4>Google Authenticator Kurulum</h4>

                                                <label class="warning">Uygulama kurulumunu
                                                    yapmadığınız takdirde sisteme erişiminizi kaydebilirsiniz</label>
                                                <label>Manuel Kod : <span>{{$ManualSetupCode}}</span></label>
                                                <label>QR Kodu : </label>
                                                <picture>
                                                    {!! strip_tags($googleAppHtml, "<img>") !!}
                                                </picture>
                                ...
                                <div class="tab-pane fade" id="pills-bildirim" role="tabpanel"
                                     aria-labelledby="pills-bildirim-tab">

                                    <div class="row g-3">

                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <label for="11" class="form-check-label">SMS Bildirimleri</label>
                                                <input name="notify_sms" id="11" class="form-check-input"
                                                       type="checkbox"
                                                       @if(Auth::user()->notify_sms == 1) checked @endif>
                                                <div class="switcher"><span><i></i></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <label for="12" class="form-check-label">Email Bildirimleri</label>
                                                <input name="notify_email" id="12" class="form-check-input"
                                                       type="checkbox"
                                                       @if(Auth::user()->notify_email == 1) checked @endif>
                                                <div class="switcher"><span><i></i></span></div>
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script>
        ...
        function googleAc() {
            if ($("#authenticator").is(':checked')) {
                $("#authenticator_image").show();
            } else {
                $("#authenticator_image").hide();
            }
        }
